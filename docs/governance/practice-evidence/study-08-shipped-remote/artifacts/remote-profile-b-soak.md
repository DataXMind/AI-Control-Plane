...
2026-06-26T10:36:10Z soak_iter health=ok policy_allowed=True tokens_remaining=2000000.0 apex=ok
```
...
| Profile B rules=10 on VPS | ✅ PASS (`policy_rules_count: 10`, agent4, datax-analytics) |
