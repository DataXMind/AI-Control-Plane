...
- Antigravity zsh auto-hook: `examples/integrate/shell/antigravity_shell_hook.zsh`, `install_antigravity_hook.sh`
- Production client bundle: `customer-bundle/integrations/` (env template + README)
- Integration enforce: `examples/integrate/python/run_tool_guarded.py` ([#188](https://github.com/DataXMind/AI-Control-Plane/pull/188))
- Practice evidence: Hybrid Gateway × ACP **CONNECT CLOSED** — [`RESULTS.md`](docs/governance/practice-evidence/hybrid-gateway-acp-integration/RESULTS.md)
...
- `docs/integrations/HYBRID_AI_GATEWAY.md` — CONNECT closed; Gateway [#4](https://github.com/DataXMind/Hybrid-AI-Gateway/pull/4) merged
- `ANCHOR_CURRENT` — integration close snapshot
